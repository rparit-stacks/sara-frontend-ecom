...
export default function ClientProjectDetail() {
  ...
  const uploadAndSend = async (text: string, atts: Attachment[], parentMessageId?: number) => {
    ...
    // Feature 3 — if the customer @sara-mentioned, post their message first (above), then
    // ask Portal AI. The AI reply is written into the same channel by the backend.
